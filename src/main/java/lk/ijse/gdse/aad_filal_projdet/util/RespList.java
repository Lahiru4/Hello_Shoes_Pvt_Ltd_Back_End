package lk.ijse.gdse.aad_filal_projdet.util;

public class RespList {
    public final static String RSP_SUCCESS              = "RSP_SUCCESS";
    public final static String RSP_NO_DATA_FOUND        = "RSP_NO_DATA_FOUND";
    public final static String RSP_NOT_AUTHORISED       = "RSP_NOT_AUTHORISED";
    public final static String RSP_TOKEN_EXPIRED        = "RSP_TOKEN_EXPIRED";
